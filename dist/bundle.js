...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rtTest = __webpack_require__(5);
	
	var _rtTest2 = _interopRequireDefault(_rtTest);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var CONTROLLERS = {
	    RtTest: _rtTest2.default
	};
	
	function dashToPascalCase(str) {
	    return str.charAt(0).concat(str.slice(1).toLowerCase()).replace(/-([a-z])/g, function (g) {
	...
	exports.default = {
	    init: function init() {
	        var Fn = CONTROLLERS[dashToPascalCase(this.root.tagName)];
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('rt-test', '<button type="button" onclick="{derp}">Test</button>', '', '', function (opts) {});
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
